...
variable "codeconnections_connection_arn" {
  ...
  type        = string
  default     = "arn:aws:codeconnections:ap-northeast-1:267375937715:connection/86a1b018-5eaf-48f0-944c-858c65d6e38c" 
}
...
variable "pipeline_artifact_s3_bucket_name" {
  ...
  type        = string
  default     = "your-unique-pipeline-artifacts-bucket-name-12345"
}
